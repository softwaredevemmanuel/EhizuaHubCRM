        ...
        <div className="lg:ml-72  bg-[#C8D1DA] px-5 flex flex-col gap-3 h-screen">
            ...
            <div className='grid grid-cols-2 mt-2'>
                <div className=''>
                    ...
                    <input type='number' placeholder='E.g 12' className='pl-4 h-[40px] w-[120px] sm:w-[180px]  rounded-md outline-none mt-1' />

                </div>
                <div>
                    <p className='text-[#134574] '> ₦ Course Price</p>
                    <input type = 'number' placeholder='E.g 600000' className='pl-4 h-[40px] w-[120px] sm:w-[180px] rounded-md outline-none mt-1' />
