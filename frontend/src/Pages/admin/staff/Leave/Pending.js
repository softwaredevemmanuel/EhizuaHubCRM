        ...
        <div className="">
            {user ? (
                ...
                <div className="lg:ml-72  bg-[#C8D1DA] px-5 flex flex-col gap-3 h-full">
                    ...
                    <div className='pl-5 rounded-xl "w-[412px] h-[50px] bg-slate-400 text-[#134574] flex items-center justify-between mt-1 pr-5'>
                        <div className='flex'>
                        ...
                        <div className='flex gap-4'>
                            <Link className="flex bg-slate-300 rounded-xl  sm:w-32 items-center justify-center">
