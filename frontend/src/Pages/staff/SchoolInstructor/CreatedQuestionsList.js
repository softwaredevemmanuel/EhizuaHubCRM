    ...
    useEffect(() => {
        ...
        async function fetchQuestions() {
            try {
                ...
                const response = await axios.get('http://localhost:5000/api/school-tutor/questions', {
                    headers: {
                        course: courseParam
                    },
                });
                                ...
                                .map((subContent, subIndex) => (
                                    <div key={subIndex}>
                                        ...
                                        <div className='p-4 text-slate-600'>
                                            ...
                                            <Link to={`/edit-school-question/${subContent.question}/${courseParam}/${mainTopic}`}> Edit</Link>
                                            </div>
