        ...
        <div className="lg:ml-72  bg-[#C8D1DA] px-5 flex flex-col gap-3 h-full">
            ...
            <form className='bg-slate-200 sm:h-fit rounded-md pb-8 '>
                <div className='sm:flex gap-4 mt-6 px-8 text-[#134574]'>
                    <p className='rounded-md w-full h-[40px] outline-none font-bold' >Full Stack Web Development </p>
                </div>
                ...
                <div className='sm:flex gap-4 sm:mt-8 px-8 text-[#134574] '>
                    ...
                    <textarea placeholder='Course Content' className='outline-none w-full rounded-md h-[80px] pl-4 pt-2' />
