                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-[#134574] px-6 pb-4 py-3">
                    ...
                    <nav className="flex flex-1 flex-col">
                            ...
                            <button className="flex w-full items-center p-3 gap-4 rounded-[4px] hover:bg-blue-300 transition-all">
                            <MdDashboard />
                                <p className="text-xs font-semibold leading-6 text-indigo-200">Dashboard</p>
                            </button>
                            </Link>
                            

                            <p className="text-xs font-semibold leading-6 text-indigo-200">OFFICES SECTION</p>
                            ...
                            <button className="flex w-full items-center p-1 gap-4 rounded-[4px] hover:bg-blue-300 transition-all">
                                <RiHomeOfficeFill />
                                <p className="text-xs font-semibold leading-6 text-indigo-200">Location</p>
                            </button>
                            </Link>
                      ...
                      <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                          <div className="text-xs font-semibold leading-6 text-indigo-200">STAFF SECTION</div>
