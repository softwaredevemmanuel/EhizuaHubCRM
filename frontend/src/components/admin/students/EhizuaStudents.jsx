  ...
  return (
    ...
    <div className="w-full lg:h-[1000px] h-[1500px] md:h-[1200px] bg-[#C8D1DA] pl-6 flex flex-col gap-3">
      ...
      <div className=' pl-1 pt-7 lg:gap-[5px] lg:ml-[-16px] sm:grid-cols-2 sigh overflow-x-hidden md:ml-[-18px] md:gap-[-30px] md:grid-cols-2 gap-[30px] items-center grid grid-cols-1 lg:grid-cols-3'>
        ...
        <Link className='bg-[#2E5881] px-5 gap-7 flex items-center h-[150px] rounded-[14px] md:w-[250px] w-[320px]'>
        ...
        <Link className='bg-[#2E5881] flex items-center  gap-7  px-5 h-[150px] rounded-[14px] md:w-[250px] w-[320px]'>
              <img className='w-[80px]' src={hub3} alt="" />
                <div className='text-white text-[16px] font-bold'>
                <h3>EHIZUA HUB</h3>
                <h3>AWOYAYA</h3>
      ...
      <h2 className='text-[#F13178] md:ml-[-16px] pt-4 font-bold lg:pt-5 pl-1 lg:text-[27px] text-[25px]'>Enterprice Location</h2>

      <div className=' pl-1 pt-7 siuuu lg:gap-[5px] md:ml-[-18px]  lg:ml-[-16px] gap-[30px] md:gap-[-30px]  items-center sm:grid-cols-2 md:grid-cols-2 grid grid-cols-1 lg:grid lg:grid-cols-3'>
...
<Link className='bg-[#2E5881] px-5 flex items-center gap-7 h-[150px]  rounded-[14px] md:w-[250px] w-[320px]'>
   ...
   <Link className='bg-[#2E5881] flex items-center gap-5  px-5 h-[150px]  rounded-[14px] md:w-[250px] w-[320px]'>
         <img className='w-[80px]' src={hub3} alt="" />
         <div className='text-white text-[16px] font-bold'>
         <h3>EHIZUA HUB</h3>
         <h3>AWOYAYA</h3>
   ...
   <Link className='bg-[#2E5881] flex items-center gap-5 px-5 h-[150px]   lg:mt-[50px] md:w-[250px] rounded-[14px] w-[320px]'>
<img className='w-[80px]' src={hub3} alt="" />
        <div className='text-white text-[16px] font-bold'>
        <h3>EHIZUA HUB</h3>
        <h3>AWOYAYA</h3>
